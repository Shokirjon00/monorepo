...
export class CategoryConstants {
  ...
  static readonly CATEGORY_COLUMNS : ICaption[] = [
    {
      key: 'Статус',
      field: 'isActive',
  ...
  static readonly TABLE_ACTIONS: IRowAction[] = [
    {
      ...
      permissionName: 'CategoryUpdate',
      iconUrl: 'icons/pen.svg',
    }
  ]

  static readonly CATEGORY_ACTIONS: IAction[] = [
    {
      code: ActionEnum.ADD,
      tooltipName: 'Добавить категорию',
      path: 'directory/categories/new',
    ...
    },
    {
      ...
      permissionName: 'CategoryExportToExcel'
    },
  ];
}

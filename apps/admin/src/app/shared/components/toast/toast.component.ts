...
export class ToastComponent extends DestroyableComponent implements OnInit, AfterViewInit, OnDestroy {
  readonly containerViewChild = viewChild<ElementRef>('container');
  readonly templates = contentChildren<any>(PrimeTemplate);
  ...
  public config = inject(PrimeNgConfigService);

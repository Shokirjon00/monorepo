export class StatusTypeConstants {
  ...
  static terminalStatus = [
    { value: 'a2050cf2-035b-45a3-85bb-ec88a3c96043', key: 'Активен' },
    { value: 'b1c8e5e7-9a3d-4c8b-9f0d-2e5f6a7b8c9d', key: 'Закрытый' },
    { value: 'c3d9f6e8-7a4b-4d9c-8e1f-3a6b7c8d9e0f', key: 'В Обработке' },
  ];
